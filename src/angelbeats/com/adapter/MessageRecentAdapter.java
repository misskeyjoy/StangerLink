...
import angelbeats.com.util.TimeUtil;
...
public class MessageRecentAdapter extends ArrayAdapter<BmobRecent> implements Filterable{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.chat_list_item_layout, parent, false);
		}
		ImageView iv_recent_avatar = ViewHolder.get(convertView, R.id.heade_cons_view);
		...
		if(avatar!=null&& !avatar.equals("")){
			...
			iv_recent_avatar.setImageResource(R.drawable.head_pic);
		}
