...
public class EmoticonsEditTextView extends EditText {

	public EmoticonsEditTextView(Context context) {
		this(context,null);
	}

	public EmoticonsEditTextView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public EmoticonsEditTextView(Context context, AttributeSet attrs) {
